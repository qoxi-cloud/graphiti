        ...
        match provider:
            ...
            case 'azure_openai':
                ...
                if azure_config.use_azure_ad:
                    ...
                    _validate_api_key('Azure OpenAI', api_key)
            ...
            case 'gemini':
                ...
                _validate_api_key('Gemini', api_key)
            ...
            case 'groq':
                ...
                _validate_api_key('Groq', api_key)
    ...
    def create(config: EmbedderConfig) -> EmbedderClient:
        ...
        match provider:
            case 'openai':
                ...
                api_key = config.providers.openai.api_key
                _validate_api_key('OpenAI Embedder', api_key)
            ...
            case 'azure_openai':
                ...
                if azure_config.use_azure_ad:
                    ...
                    api_key = azure_config.api_key
                    _validate_api_key('Azure OpenAI Embedder', api_key)
            ...
            case 'gemini':
                ...
                api_key = config.providers.gemini.api_key
                _validate_api_key('Gemini Embedder', api_key)
            ...
            case 'voyage':
                ...
                _validate_api_key('Voyage Embedder', api_key)
